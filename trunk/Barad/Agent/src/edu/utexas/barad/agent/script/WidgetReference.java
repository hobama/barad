package edu.utexas.barad.agent.script;
...
//    private WidgetFinder finder;
    ...
    private PointProxy point = PointProxy.Factory.newPointProxy(-1, -1);

    /**
     * For general widget lookup by class name.
     *
     * @param id
     *            Desired ID for the reference. Only used if this reference is to be passed as the
     *            parent, window, or invoker of another.
     * @param widgetClass
     *            Class of the widget (required)
     */
     ...
     *            Name of the widget, or null
     * @param tag
     *            Tag as returned by WidgetTester.getTag(WidgetProxy)
     */
    public WidgetReference(String id, Class widgetClass, String name, String tag) {
     ...
     *            Tag as returned by WidgetTester.getTag(WidgetProxy)
     * @param title
     *            Owning Frame/Dialog title, or null
     */
    public WidgetReference(String id, Class widgetClass, String name, String tag, String title) {
     ...
     *            Owning Frame/Dialog title, or null
     * @param text
     *            The text of the widget as returned by widget.getText(), or null
     */
    public WidgetReference(String id, Class widgetClass, String name, String tag, String title,
            String text) {
     ...
     *            Window reference, invoker, or null
     * @param text
     *            widget's text
     */
    public WidgetReference(String id, Class widgetClass, String name, String tag, String title,
            WidgetReference parent, int index, WidgetReference invokerOrWindow, String text) {
        // hack, kinda
        ...
        // }
        // else {
        windowID = invokerOrWindow != null ? invokerOrWindow.getID() : null;
        // }
        this.title = title;
    }

    /**
     * Creates a WidgetReference object for the given WidgetProxy
     */
//    public WidgetReference(Resolver resolver, WidgetProxy widget) {
//        // this.resolver = resolver;
//        this.finder = WidgetFinderImpl.getDefault();
//        WidgetTester wt = WidgetTester.getTester(widget);
//        // TODO: fix this
//        Class refClass = widget.getClass();
//        WidgetProxy parent = resolver.getHierarchy().getParent(widget);
//        // WidgetProxy win = null;
//
...
//        // if (null != parent) {
//        // WidgetProxy[] children = finder.getWidgetChildren(parent,false);
...
//                    Log.warn(exc);
//                    exc.printStackTrace();
//                    throw new Error("Reverse lookup failed for " + toString() + " trying to match "
//                            + /* WidgetTester.toString( */widget);
//
//                }
//            }
//        } catch (NotFoundException cnf) {
...
//    }
    ...
    /**
     * Return whether this reference has the same class or is a superclass of the given widget's
     * class. Simply compare class names to avoid class loader conflicts. Note that this does not
     * take into account interfaces (which is okay, since with GUI widgets we're only concerned with
     * class inheritance).
     */
    public boolean isAssignableFrom(Class cls) {
        return cls != null
                && (refClassName.equals(cls.getName()) || isAssignableFrom(cls.getSuperclass()));
    }
    ...
    public PointProxy getInvocationLocation() {
        return point;
    }

    /**
     * Returns a widget class-specific tag used to match this reference to a real widget.
     */
    public String getTag() {
        return tag;
    }

//    public WidgetProxy getWidget() throws NotFoundException, MultipleFoundException {
//        if (resolver == null)
//            throw new NotFoundException("No default hierarchy has been provided");
//        return getWidget(resolver.getHierarchy());
//    }
//
//    public WidgetProxy getWidget(WidgetHierarchy hierarchy) throws NotFoundException,
//            MultipleFoundException {
//
//        WidgetMatcher[] matcher = {
//                getText() != null && !getText().equals("") ? new WidgetTextMatcher(getText()) : null,
//                getName() != null && !getName().equals("") ? new NameMatcher(getName()) : null,
//                /* new ClassMatcher (ref.getClass() ) */null
//        /*
//         * TODO: match on other stuff such as tag, etc. No tagmatcher currently exists -- necessary?
//         */
//        };
//        WidgetFinder finder = new WidgetFinderImpl(hierarchy);
//        return finder.find(new CompositeMatcher<WidgetProxy>(matcher));
//
//    }
