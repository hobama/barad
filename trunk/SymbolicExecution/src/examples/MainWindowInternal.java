...
public class MainWindowInternal extends Composite {
	...
	*/
	public static void showGUI() { 
		...
		MainWindowInternal inst = new MainWindowInternal(shell, SWT.NULL);
	...
	public MainWindowInternal(Composite parent, int style) {
		super(parent, style);
