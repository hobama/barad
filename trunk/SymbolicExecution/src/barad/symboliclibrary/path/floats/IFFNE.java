 ...
 */
public class IFFNE extends IntegerPathConstraint implements Serializable {
	private static final long serialVersionUID = 1L;
	
	public IFFNE(IntegerInterface op1) {
	...
	@Override
	public Object clone() {
		IFFNE ifne = new IFFNE((IntegerInterface)op1.clone());
