 ...
 */
public class NotEquals extends SymbolicStringEquality implements Serializable { 
	 ...
	 */
	public NotEquals(StringInterface op1, StringInterface op2) {
		super(op1, op2, Type.NOT_EQUAL);
	}
