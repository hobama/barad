...
public class SymbolicExecutionThread extends Thread {
	...
	static { 
		try {
			symbolicComposite = Class.forName("barad.symboliclibrary.ui.widgets.SymbolicComposite");
			symbolicIntegerInterface = Class.forName("barad.symboliclibrary.integers.IntegerInterface");
		} catch (ClassNotFoundException cnfe) {
			Logger.getLogger(SymbolicExecutionThread.class).error(cnfe);
		}
	}
